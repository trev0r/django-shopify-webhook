...
shop_redact = WebhookSignal()
customers_redact = WebhookSignal()
customers_data_request = WebhookSignal()
app_subscriptions_update = WebhookSignal()
...
app_scopes_update = WebhookSignal()
